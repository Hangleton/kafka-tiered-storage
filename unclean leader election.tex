...
\begin{figure}[h!]
	...
	\captionof{figure}{Left segment overlap in tiered storage as a result of base offset misalignment.}
	\label{fig:left-overlap}
\end{figure}

\begin{figure}[h!]
	\includegraphics[scale=0.4]{right-overlap.png}
	\captionof{figure}{Right segment overlap in tiered storage as a result of base offset misalignment.}
